    ...
    <div>
      ...
      <div className="p-2 mt-2">
        ...
        <div className="rounded shadow ">
          <h3 className='font-extrabold text-2xl p-4 border-b-2 border-gray-300'>Cricket</h3>
          <div className='flex justify-center items-center flex-wrap gap-2 py-2'>
            {
              products.map((product) => {
                return <JerseyCart product={product} />
              })
            }
          </div>
        </div>
        <div className="rounded shadow mt-2">
          <h3 className='font-extrabold text-2xl p-4 border-b-2 border-gray-300'>Football</h3>
          <div className='flex justify-center items-center flex-wrap gap-2 py-2'>
            {
              products.map((product) => {
                return <JerseyCart product={product} />
